...
- The *mutSignatures* framework was developed in the Meeks Lab at Northwestern University (Chicago, IL), was described by [Fantini D et al, 2020](https://www.biorxiv.org/content/10.1101/2020.03.15.992826v1), and was built upon a custom R-based implementation of the original MATLAB WTSI framework by [Alexandrov LB et al, 2013](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3588146/).   

- The *mutSignatures* framework has been used for analyses described in peer-reviewed publications, including [Fantini D et al, 2018](https://www.nature.com/articles/s41388-017-0099-6) and [Fantini D et al, 2019](https://www.ncbi.nlm.nih.gov/pubmed/30446446). 
...
- **Our biorxiv** describing the latest version of the software: *MutSignatures: An R Package for Extraction and Analysis of Cancer Mutational Signatures*, [https://www.biorxiv.org/content/10.1101/2020.03.15.992826v1](https://www.biorxiv.org/content/10.1101/2020.03.15.992826v1)
...
Thanks for your interest in our software. If you run into any issue, bug, or you have a question about `mutSignatures`, feel free to email <damiano.fantini@gmail.com>. This project is mainly supported by *DF* in his free time. **C-2020** *(July-02, 2020)*.
